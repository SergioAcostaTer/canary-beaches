//
//package com.canary.beaches.utils;
//
...
//
//            //parallelStream() is used to process records in parallel
//
////            csvToBean.stream().parallel().forEach(this::processCsvRecord);
//
...
//            LOGGER.info("Successfully saved record: {}", dto.getName());
//        } catch (Exception e) {
//            LOGGER.error("Error processing record: {}", dto.getName(), e);
//        }
//    }
//
...
//        beach.setSandColor(parseSandColor(dto.getSandColor()));
...
//        beach.setBathingCondition(parseConditions(dto.getBathingCondition()));
...
//        beach.setPmrShade(parseBoolean(dto.getPmrShade()));
//        beach.setSunbedRentals(parseBoolean(dto.getSunbedRentals()));
//        beach.setUmbrellaRentals(parseBoolean(dto.getUmbrellaRentals()));
//        beach.setWaterSportsRentals(parseBoolean(dto.getWaterSportsRentals()));
//        beach.setHasToilets(parseBoolean(dto.getToilets()));
//        beach.setHasShowers(parseBoolean(dto.getShowers()));
//        beach.setHasFootShowers(parseBoolean(dto.getFootShowers()));
//        beach.setAssistedBathing(parseBoolean(dto.getAssistedBathing()));
//        beach.setIsWindy(parseIsWindy(dto.getBathingCondition()));
//        beach.setSandComposition(dto.getSandComposition());
//        return beach;
//    }
//
//    private SandColor parseSandColor(String sandColor) {
//        if (sandColor == null) return null;
//        try {
//            if (sandColor.toLowerCase().contains("blanca")) {
//                return SandColor.WHITE;
//            } else if (sandColor.toLowerCase().contains("oscura")) {
//                return SandColor.DARK;
//            } else if (sandColor.toLowerCase().contains("dorada")) {
//                return SandColor.GOLDEN;
//            } else {
//                return null;
//            }
//        } catch (IllegalArgumentException e) {
//            LOGGER.warn("Unknown sand color: {}", sandColor);
//            return null;
//        }
//    }
//
//    private Conditions parseConditions(String conditions) {
//        if (conditions == null) return null;
//        try {
//            if (conditions.toLowerCase().contains("tranquilas")) {
//                return Conditions.CALM_WATERS;
//            } else if (conditions.toLowerCase().contains("moderado")) {
//                return Conditions.MODERATE_WAVES;
//            } else if (conditions.toLowerCase().contains("fuerte")) {
//                return Conditions.ROUGH_SEA;
//            } else {
//                return null;
//            }
//        } catch (IllegalArgumentException e) {
//            LOGGER.warn("Unknown conditions: {}", conditions);
//            return null;
//        }
//    }
//
//    private boolean parseIsWindy(String isWindy) {
//        if (isWindy == null) return false;
//        return isWindy.toLowerCase().contains("ventosa");
//    }
//
...
//        if (levelName == null || levelName.isBlank() || levelName.isEmpty()) return null;
//        try {
